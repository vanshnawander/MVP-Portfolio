      ...
      >
        {filteredItems.map((item) => (
          ...
          >
            ...
            <h4 className="text-xl font-semibold group-hover:text-primary-500 transition-colors">
              {item.title}
            </h4>
            ...
            {item.link && (
              <a 
                href={item.link} 
                className="inline-flex items-center text-primary-500 hover:text-primary-600 dark:text-primary-400 dark:hover:text-primary-300 text-sm font-medium"
              >
